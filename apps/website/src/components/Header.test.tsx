...
describe("Header", () => {
  test("renders the brand, primary navigation, and external API link", () => {
    ...
    expect(dashboardLink.getAttribute("data-active-class")).toContain("bg-secondary");
    expect(dashboardLink.getAttribute("data-active-class")).toContain("text-secondary-foreground");
    expect(dashboardLink.className).toContain("group/button");
    expect(dashboardLink.className).toContain("hover:bg-muted");
    ...
    expect(statusLink.getAttribute("data-active-class")).toContain("bg-white");
    ...
    expect(apiHealthLink.className).toContain("border");
    expect(apiHealthLink.className).toContain("bg-background");
